...
function writeEnvFile(values, existingEnv) {
    const orderedKeys = [
        ...
        'TELEGRAM_WHITELIST', 'WEBHOOK_BASE_URL', 'TELEGRAM_WEBHOOK_PORT',
        'TELEGRAM_FORCE_IPV4',
...
async function main() {
    ...
    if (telegramEnabled) {
        ...
        telegram.webhookUrl = await ask(i18n.telegramConfig.webhookUrl, existingEnv.WEBHOOK_BASE_URL || '');
    ...
    const envValues = {
        ...
        ...(telegramEnabled ? {
            ...
            WEBHOOK_BASE_URL: telegram.webhookUrl,
